from boot.items import BootItem
from scrapy import Spider, Request
import re


class BootSpider(Spider):
    name = 'boot_spider'
    allowed_urls = ['https://www.zappos.com']
    start_urls = ['https://www.zappos.com/men-boots/CK_XARCz1wHAAQLiAgMBAhg.zso']
    ...
    def parse(self, response):
        ...
        result_urls = ['https://www.zappos.com/men-boots/CK_XARCz1wHAAQLiAgMBAhg.zso?p={}'.format(x) for x in range(num_pages)] 
