from running.items import RunningItem
from scrapy import Spider, Request
import re


class RunningSpider(Spider):
    name = 'running_spider'
    allowed_urls = ['https://www.zappos.com']
    start_urls = ['https://www.zappos.com/men-running-shoes/CK_XARC81wEY0O4BwAEC4gIEAQIDGA.zso']
    ...
    def parse(self, response):
        ...
        result_urls = ['https://www.zappos.com/men-running-shoes/CK_XARC81wEY0O4BwAEC4gIEAQIDGA.zso?p={}'.format(x) for x in range(num_pages)] 
