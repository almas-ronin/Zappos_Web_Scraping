...
class OxfordSpider(Spider):
    ...
    start_urls = ['https://www.zappos.com/men-oxfords/CK_XARC31wHAAQLiAgMBAhg.zso']
    ...
    def parse(self, response):
        ...
        result_urls = ['https://www.zappos.com/men-oxfords/CK_XARC31wHAAQLiAgMBAhg.zso?p={}'.format(x) for x in range(num_pages)] 
