from sneakers.items import SneakersItem
from scrapy import Spider, Request
import re


class SneakersSpider(Spider):
    name = 'sneakers_spider'
    allowed_urls = ['https://www.zappos.com']
    start_urls = ['https://www.zappos.com/men-lifestyle-sneakers/CK_XARC81wEYz-4BwAEC4gIEAQIDGA.zso']
    ...
    def parse(self, response):
        ...
        result_urls = ['https://www.zappos.com/men-lifestyle-sneakers/CK_XARC81wEYz-4BwAEC4gIEAQIDGA.zso?p={}'.format(x) for x in range(num_pages)] 
